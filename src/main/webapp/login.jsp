...
<div class="hero-unit" id="form-signin">
    <form class="form-signin" onsubmit="return checkSignInForm(this)" method="post" action="${pageContext.request.contextPath}login">
        <div id="form-signin-body">
            ...
            <c:if test="${sessionScope.signInError}">
                <div class="alert alert-error" id="loginError">
                    <p>User with such data does not exist</p>
                </div>
            </c:if>
            <c:if test="${not empty sessionScope.signInMessage}">
